...
export function loadState() {
  ...
  try {
    ...
    if (raw) {
      ...
      // Validate expected shape — return default if corrupted
      if (!parsed.learners || !parsed.lessons || !parsed.ui) return defaultState();
      return parsed;
    }
    ...
    console.warn('LoopLearn: localStorage corrupted, starting fresh');
  }
  return defaultState();
}
